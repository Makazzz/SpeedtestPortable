DEVELOPER: Replace occurrences of SpeedtestPortable in this file with the
...
user in an INI file next to SpeedtestPortable.exe called SpeedtestPortable.ini.
...
copy AppNamePortable.ini from this directory to SpeedtestPortable.ini next to
SpeedtestPortable.exe. The options in the INI file are as follows:
